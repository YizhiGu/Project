package helper;
import constant_enum.AccountEnum;
...
import static constant_enum.AccountEnum.ACCOUNT_1;
import static constant_enum.AccountEnum.ACCOUNT_2;
...
public class AccountHelper {
	  private static AccountHelper ourInstance = new AccountHelper();
	   ...
	   //initial all services for account//
	   public void service(AccountEnum accountEnum) {
	    ...
	    /*This method create the corresponding abstract factory for account*/
